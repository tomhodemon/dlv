...
import model_utils.boxes as box_ops
import model_utils._utils as det_utils
from model_utils.anchor_utils import DefaultBoxGenerator
from model_utils.transform import GeneralizedRCNNTransform
...
class SSD(nn.Module):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        size = (300, 300)
        self.num_classes = 91
        self.backbone = SSDFeatureExtractorVGG(backbone=VGG16(self.num_classes).features, highres=False)
        ...
        if head is None:
            if hasattr(self.backbone, "out_channels"):
                ...
                out_channels = det_utils.retrieve_out_channels(self.backbone, size)
